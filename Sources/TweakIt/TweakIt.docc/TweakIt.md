...
TweakIt lets you define tweakable parameters once in a declarative Swift DSL and get a full debug panel for free. Drag sliders, flip toggles, pick from options — see changes in real time without a rebuild.
