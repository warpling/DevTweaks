# Getting Started with TweakIt

Add runtime-tweakable parameters to your app in three steps.

## Overview

TweakIt gives you a debug panel that reads tweak definitions from a declarative DSL. You define your parameters once, and the library generates the appropriate controls (sliders, toggles, pickers, etc.) automatically.

## Install the Package

Add TweakIt via Swift Package Manager:
