...
public struct TweaksListView: View {
    ...
    @State private var collapsedCategories: Set<String> = {
        let saved = UserDefaults.standard.stringArray(forKey: "TweakIt.collapsedCategories") ?? []
        return Set(saved)
    }()
                ...
                if isCollapsed {
                    ...
                    CategoryHeaderView(
                        ...
                        withAnimation(.easeInOut(duration: 0.2)) {
                            ...
                            UserDefaults.standard.set(Array(collapsedCategories), forKey: "TweakIt.collapsedCategories")
                        }
                    }
                    .textCase(nil)
